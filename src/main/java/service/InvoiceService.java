...
public class InvoiceService {
    ...
    public String generateNextInvoiceNo() {
        return invoiceDAO.generateNextInvoiceNo();
    }

    public boolean insertInvoice(Invoice invoice) {
        if (invoice == null || invoice.getCustomerName() == null) return false;
        invoice.setInvoiceNo(invoiceDAO.generateNextInvoiceNo());
    ...
    public boolean deleteInvoice(String invoiceNo) {
        return invoiceDAO.deleteInvoice(invoiceNo);
    }
